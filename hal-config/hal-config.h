...
#define BSP_SERIAL_ASSERT_PORT                   (HAL_SERIAL_PORT_USART1)
...
// $[USART1]
#define PORTIO_USART1_RX_PIN                     (9U)
#define PORTIO_USART1_RX_PORT                    (gpioPortC)
#define PORTIO_USART1_RX_LOC                     (13U)

#define PORTIO_USART1_TX_PIN                     (10U)
#define PORTIO_USART1_TX_PORT                    (gpioPortC)
#define PORTIO_USART1_TX_LOC                     (15U)

#define HAL_USART1_ENABLE                        (1)

#define BSP_USART1_RX_PIN                        (9U)
#define BSP_USART1_RX_PORT                       (gpioPortC)
#define BSP_USART1_RX_LOC                        (13U)

#define BSP_USART1_TX_PIN                        (10U)
#define BSP_USART1_TX_PORT                       (gpioPortC)
#define BSP_USART1_TX_LOC                        (15U)
...
// $[Custom pin names]
#define PAIRING_BUTTON_PIN                       (2U)
#define PAIRING_BUTTON_PORT                      (gpioPortA)

#define STATUS_PIN_PIN                           (3U)
#define STATUS_PIN_PORT                          (gpioPortA)
